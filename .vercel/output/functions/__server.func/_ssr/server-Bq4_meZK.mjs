...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BM16zx2h.mjs");
...
var manifest = { "761ea1fcb4b1a747c424a31d8a3427a252f9d4c046b43ca2b563d579a34fd28f": {
	functionName: "syncBlogFeeds_createServerFn_handler",
	importer: () => import("./blog.functions-pPfOx2U5.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CotFlDs_.mjs").then((n) => n.a).then((n) => n.t),
		import("./start-g69RrWQy.mjs"),
