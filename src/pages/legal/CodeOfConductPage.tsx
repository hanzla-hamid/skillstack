...
const sections = [
  {
    ...
    body: [
      "SkillStack is committed to providing a safe, inclusive, and respectful learning environment for all students, instructors, and staff. This Code of Conduct outlines the standards of behavior we expect from every member of our community.",
      "By enrolling in any SkillStack program, you agree to uphold these standards both in physical classrooms and in online interactions.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "If you witness or experience behavior that violates this Code of Conduct, report it to SkillStack staff or through our contact email. All reports are treated confidentially.",
      "Retaliation against anyone who reports a violation in good faith is itself a violation of this Code.",
    ],
  },
  {
