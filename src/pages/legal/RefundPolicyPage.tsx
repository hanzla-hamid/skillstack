...
const sections = [
  ...
  },
  {
    ...
    body: [
      "Medical emergencies with supporting documentation may qualify for a prorated refund or course deferral, subject to review.",
      "Relocation or job transfer does not automatically qualify for a refund but may be considered for online course transfer where available.",
    ],
  },
];
